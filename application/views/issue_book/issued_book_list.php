                                ...
                                <table id="example" class="table table-hover">
                                    ...
                                    foreach ($issuedBookData as $issueData){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $issueData->issueDate; ?>

                                            </td>

                                            <td>

                                                <a  href="#myModal" role="button" data-toggle="modal"><i class="fa fa-trash"></i></a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-danger" href="<?php echo base_url(); ?>book/deleteBook/" >Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
